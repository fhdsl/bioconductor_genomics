...
- Experimental conditions that relate to your scientific question of interest, such as: case vs. control, time series, etc.
...
- If not possible, make sure that all experimental conditions have a similar amount of variability of the confounding variable.
